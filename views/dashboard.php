...
<body>
    ...
    <div class="dashboard-layout">
        <nav>
            <ul>
                <li><a href="../controllers/DashboardController.php" class="active">Dashboard</a></li>
                <li><a href="../controllers/OffresController.php">Offres de stage</a></li>
                <li><a href="../controllers/DemandesController.php">Demandes de lettres</a></li>
                <li><a href="../controllers/EtudiantsController.php">Etudiants</a></li>
                <li><a href="../controllers/StatistiquesController.php">Statistiques</a></li>
                <li><a href="../controllers/ParametresController.php">Paramètres</a></li>
            </ul>
        </nav>
        <main>
            <section>
